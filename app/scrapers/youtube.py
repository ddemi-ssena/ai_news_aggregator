...
#url formatından id alıyorum
    ...
    def get_transcript(self, video_id: str) -> Optional[Transcript]:
        try:
            ...
            return None
# videonun transkrip metnini çekiyorum
    def get_latest_videos(self, channel_id: str, hours: int = 24) -> list[ChannelVideo]:
        ...
        return videos
        #rss feedden videoları çekiyor ve 24 saat filtresi uyguluyor. shortsları filtreliyor
...
#full pipeline kanal videolarını getirir, her video için transkrip indirir, transkripti video objesine ekler, hazır liste döner
...
#kodun çalıştırıldığı kısım
#jqd6_bbjhS8 ID'li videonun altyazısını yazdırır.
#Belirttiğin kanaldan son 200 saat içinde yüklenen videoları çeker.
#Her video için transcript ekler.
#bunları liste olarak döner.